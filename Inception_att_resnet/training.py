...
def get_callbacks(save_path,initial_learning_rate,learning_rate_drop=0.5, learning_rate_epochs=20,
    ...
    if early_stopping_patience:
        callbacks.append(EarlyStopping(monitor='loss', patience=early_stopping_patience,mode='auto'))
    ...
    model_checkpoint = ModelCheckpoint(filepath, monitor= 'loss',verbose=1, save_weights_only=False, save_best_only=True, period=5)
